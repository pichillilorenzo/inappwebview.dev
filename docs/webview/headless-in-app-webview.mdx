...
description: The HeadlessInAppWebView class represents a WebView in headless mode.
---
...
<Tabs>
    <TabItem value={Platform.Android} label={Platform.Android} default>
        ![Android headless webview basic
        usage](./headless-in-app-webview/android-headless-in-app-webview-basic-usage.gif "Android headless webview basic
        usage.")
    </TabItem>
    <TabItem value={Platform.iOS} label={Platform.iOS}>
        ![iOS headless webview basic usage](./headless-in-app-webview/ios-headless-in-app-webview-basic-usage.gif "iOS
        headless webview basic usage.")
    </TabItem>
</Tabs>
...
<SupportedPlatforms
    platforms={[Platform.Android, Platform.iOS, Platform.macOS, Platform.Web]}></SupportedPlatforms>
...
<Tabs>
    <TabItem value={Platform.Android} label={Platform.Android} default>
        ![Android headless to inappwebview
        example](./headless-in-app-webview/android-headless-to-inappwebview-example.gif "Android headless to
        inappwebview example.")
    </TabItem>
    <TabItem value={Platform.iOS} label={Platform.iOS}>
        ![iOS headless to inappwebview example](./headless-in-app-webview/ios-headless-to-inappwebview-example.gif "iOS
        headless to inappwebview example.")
    </TabItem>
</Tabs>
