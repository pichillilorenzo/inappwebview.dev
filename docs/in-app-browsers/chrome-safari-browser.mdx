...
description: The ChromeSafariBrowser class represents Chrome Custom Tabs on Android and SFSafariViewController on iOS.
---
...
The `ChromeSafariBrowser` class represents [Chrome Custom Tabs](https://developer.chrome.com/docs/android/custom-tabs/overview/) on Android and [SFSafariViewController](https://developer.apple.com/documentation/safariservices/sfsafariviewcontroller) on iOS.
...
<Tabs>
    <TabItem value={Platform.Android} label={Platform.Android} default>
        ![ChromeSafariBrowser android basic usage](./chrome-safari-browser/android-chrome-safari-browser-basic-usage.gif
        "ChromeSafariBrowser android basic usage.")
    </TabItem>
    <TabItem value={Platform.iOS} label={Platform.iOS}>
        ![ChromeSafariBrowser iOS basic usage](./chrome-safari-browser/ios-chrome-safari-browser-basic-usage.gif
        "ChromeSafariBrowser iOS basic usage.")
    </TabItem>
</Tabs>
